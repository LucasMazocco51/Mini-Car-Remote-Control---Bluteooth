 ...
 * C/C++ source code generated on : Sat Jan 11 10:37:59 2025
 *
...
void mini_car_ble_step(void)
{
  ...
  if ((mini_car_ble_U.rx_set_speed == 4) || (mini_car_ble_DW.UnitDelay3_DSTATE ==
     ...
     */
    mini_car_ble_B.Merge1 = 0.88 * rtb_Multiply;
     ...
     *  SignalConversion generated from: '<S78>/LMotor'
     */
    mini_car_ble_B.Merge1 = rtb_Multiply;
     ...
     */
    mini_car_ble_B.Merge_c = 0.88 * rtb_Multiply;
